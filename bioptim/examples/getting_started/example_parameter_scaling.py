...
def prepare_ocp(
    ...
    # Add objective functions
    objective_functions = ObjectiveList()
    # objective_functions.add(ObjectiveFcn.Lagrange.TRACK_CONTROL, key="tau", target=tau_to_track, weight=1)
    # objective_functions.add(ObjectiveFcn.Lagrange.TRACK_STATE, key="q", target=q_to_track[:, :-1], weight=1)
    # objective_functions.add(ObjectiveFcn.Lagrange.TRACK_STATE, key="qdot", target=qdot_to_track[:, :-1], weight=1)
